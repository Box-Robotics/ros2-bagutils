...
class TestSequential(unittest.TestCase):
    """
    Test fixture for sequential (uncompressed) read/write access to a ROS2 bag
    using the lower-level C++ interface.
    """
    ...
    def setUp(self):
        ...
        self.comp_opt.compression_mode = baggie._CompressionMode.NONE
